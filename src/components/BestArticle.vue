...
<template>
<h1>  <div v-if="reviewArticles" class="flex flex-col">
      ...
      >
      <button class=" border ml-2 p-2 h-[40px] px-4  text-white rounded" :class="article.Selected ? 'bg-red-600' : 'bg-green-600'">{{ article.Selected ? '從精選文章刪除' : '新增為精選文章' }}</button>
